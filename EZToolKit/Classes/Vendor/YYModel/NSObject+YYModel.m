    ...
    if (meta->_isCNumber) {
        ...
        switch (meta->_type & YYEncodingTypeMask) {
            case YYEncodingTypeObject: {
                ...
                else if ([value isKindOfClass:[NSString class]]) {//支持对json字符串转class
                    NSObject *one = nil;
                    if (meta->_getter) {
                        one = ((id (*)(id, SEL))(void *) objc_msgSend)((id)model, meta->_getter);
                    }
                    if (one) {
                        [one yy_modelSetWithJSON:value];
                    } else {
                        one = [cls new];
                        [one yy_modelSetWithJSON:value];
                        ((void (*)(id, SEL, id))(void *) objc_msgSend)((id)model, meta->_setter, (id)one);
...
- (BOOL)yy_modelSetWithJSON:(id)json {
    NSDictionary *dic = [NSObject yy_dictionaryWithJSON:json];
